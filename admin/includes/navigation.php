                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="dashboard.php">
                            <b class="">
                                <!-- Dark Logo icon -->
                                <img src="../assets/images/HostelXpress.png" alt="homepage" class="dark-logo"  style="height:70px;"/>
                                <!-- Light Logo icon -->
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                     ...
                     <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item" href="profile.php" style="font-family: Arial, sans-serif; font-size: 16px;"><i data-feather="user" class="svg-icon mr-2 ml-1"></i> My Profile</a>
                        ...
                        <a class="dropdown-item" href="logout.php" style="font-family: Helvetica, sans-serif; font-size: 18px;"><i data-feather="power" class="svg-icon mr-2 ml-1"></i> Logout</a>
                    </div>
