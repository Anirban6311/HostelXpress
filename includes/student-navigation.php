                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            <b class="logo-icon">
                                <!-- Dark Logo icon -->
                                <img src="../assets/images/HostelXpress.png" alt="homepage" class="dark-logo" style="width: 140px; height: 70px">
                                <!-- Light Logo icon -->
                                <img src="../assets/images/HostelXpress.png" alt="homepage" class="light-logo" />
                            </b>
                            <!--End Logo icon -->
                            <!-- Logo text -->
